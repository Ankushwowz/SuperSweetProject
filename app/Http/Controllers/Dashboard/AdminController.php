...
class AdminController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if($request->file('admin_avatar')){
            ...
            $attributes['admin_avatar']= $filename;
        }
        ...
        $admin = Admin::create([
            ...
            'admin_avatar' => $attributes['admin_avatar'] ?? NULL
        ]);
    ...
    public function update(Request $request, Admin $admin)
    {
		...
		if($request->file('admin_avatar')){
        if ($request->admin_avatar) {
            Storage::delete($admin->getAttributes()['admin_avatar']);
        ...
        /*if ($request->avatar) {
            ...
            $attributes['avatar'] = $request->avatar->store('public/admin_avatars');
        }*/
        if ($request->password) {
