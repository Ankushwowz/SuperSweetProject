                                ...
                                <div class="form-group last">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <label class="floating-label">Admin Image</label>
											  <img src="{{asset('public/admin_avatar/'.$admin->admin_avatar)}}"
                                                 alt=""/>
                                        ...
                                        <div>
                                                <span class="btn btn-dark btn-file">
                                                    ...
                                                    <input type="file" name="admin_avatar"
                                                           value="{{ $admin->admin_avatar }}">
                                                </span>
                                            <a href="" class="btn btn-danger fileinput-exists"
                                               data-dismiss="fileinput">
                                                Remove </a>
                                        </div>
                                        <span style="color: red; margin-left: 10px">{{ $errors->first('admin_avatar') }}</span>
                                    </div>
                                </div>
