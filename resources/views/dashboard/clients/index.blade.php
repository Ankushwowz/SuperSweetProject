            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-7 col-sm-12">
                    ...
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{url('dashboard')}}"><i class="zmdi zmdi-home"></i> Super Sweet</a>
                        </li>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="list-icon">
                                                        ...
                                                        <img class="patients-img" src="{{ URL::to('/') }}/public/client_avatars/{{$client->avatar}}" alt="" style="width: 50px; height: 50px">
                                                        @else
                                                        <img class="patients-img" src="{{ URL::to('/') }}/public/images/default.png" alt="" style="width: 50px; height: 50px">
                                                        @endif
                                                    </span>
                                                </td>
