                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control" name="categories">
											...
											<option value="{{ $category->id }}" {{ $film->categories== $category->id ? 'selected="selected"' : '' }}>{{ $category->name }} </option>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control" name="actors">
											...
											<option value="{{ $actor->id }}" {{ $film->actors== $actor->id ? 'selected="selected"' : '' }}>{{ $actor->name }} </option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="overview" rows="4" class="form-control no-resize"
                                                      placeholder="Video Overview">{{ $film->overview }}</textarea>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <label class="floating-label">Upload Cover Image</label>
											  <img src="{{asset('public/video_background_covers/'.$film->background_covers)}}"
                                                 alt=""/>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="shortvideo" class="form-control"
                                                   placeholder="Short Video" value="{{$film->shortvideo}}">
