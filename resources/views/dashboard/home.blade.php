                        ...
                        <ul class="row profile_state list-unstyled">
                            ...
                            <li class="col-lg-3 col-md-3 col-6">
                                <div class="body">
                                    ...
                                    <h4>{{$clients}}</h4>
                                    <a href="{{url('dashboard/clients')}}" style="color: #424242;"><span>Users</span></a>
                                </div>
                            </li>
                            <li class="col-lg-3 col-md-3 col-6">
                                <div class="body">
                                    ...
                                    <h4>{{$categories}}</h4>
                                    <a href="{{url('dashboard/categories')}}" style="color: #424242;"><span>Categories</span></a>
                                </div>
                            </li>
                            <li class="col-lg-3 col-md-3 col-6">
                                <div class="body">
                                    ...
                                    <h4>{{$films}}</h4>
                                    <a href="{{url('dashboard/films')}}" style="color: #424242;"><span>Videos</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card">
						...
						<li class="col-lg-3 col-md-3 col-6">
                                <div class="body">
                                    ...
                                    <h4>{{$actors}}</h4>
                                    <a href="{{url('dashboard/actors')}}" style="color: #424242;"><span>Models</span></a>
                                </div>
                            </li>
