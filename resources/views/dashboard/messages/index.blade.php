            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-7 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{url('dashboard')}}"><i class="zmdi zmdi-home"></i> Super Sweet</a></li>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(".show_message").click(function () {
                    ...
                    //alert(overview); return false;
                    swal({
                        title: "<spna style='color: #8CD4F5'>Message</span>",
