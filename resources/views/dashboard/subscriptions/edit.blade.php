        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Edit</strong> Subscription</h2>
                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plan_name" class="form-control"
                                                   placeholder="Plane Name" value="{{ $subscription->plan_name }}">
								...
								<div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plan_duration" class="form-control"
                                                   placeholder="Plan Duration" value="{{ $subscription->plan_duration }}">
									...
									<div class="col-sm-6">
                                        ...
                                        <select class="form-control z-index" name="plan_time" >                                                                                    
											...
											<option value="day" {{ ($subscription->plan_time) == 'day' ? 'selected' : '' }}>day</option>
											<option value="month" {{ ($subscription->plan_time) == 'month' ? 'selected' : '' }}>Month</option>
                                        </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plan_price" class="form-control"
                                                   placeholder="Plan Price" value="{{ $subscription->plan_price }}">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="plan_description" rows="4" class="form-control no-resize"
                                                      placeholder="Plan Description">{{ $subscription->plan_description }}</textarea>
								...
								<div class="form-group last">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="{{asset('public/subscriptions/'.$subscription->subscription_image)}}"
                                                 alt=""/>
                                        </div>
                                        ...
                                        <div>
                                                <span class="btn btn-dark btn-file">
                                                    ...
                                                    <input type="file" name="subscription_image"
                                                           value="{{$subscription->subscription_image}}">
                                                </span>
